...
namespace WeatherGame.Framework.physics.Character
{
    /// <summary>
    ...
    public class StepManager
    {
        ...
        PositionState TryUpStepPosition(ref Vector3 sideNormal, ref Vector3 position, out float hintOffset)
        {
            ...
            if (character.QueryManager.HeadContacts.Count > 0)
            {
                ...
                float dot;
                Vector3Ex.Dot(ref up, ref character.QueryManager.HeadContacts.Elements[0].Normal, out dot);
                ...
                {
                    Vector3Ex.Dot(ref up, ref character.QueryManager.HeadContacts.Elements[i].Normal, out dot);
